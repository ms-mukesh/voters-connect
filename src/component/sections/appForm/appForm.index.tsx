...
const AppForm = (props: AppFormType) => {
    ...
    const _onChangFeedValue = (text: any, onChangeStateMethod: any) => {
        onChangeStateMethod !== null &&
            onChangeStateMethod(text.nativeEvent.text);
    };
    ...
    const _onGetValueFromDatePicker = (date: any) => {
        ...
        if (
            fields?.length > 0 &&
            calculatedCurrentFieldIndex < fields?.length
        ) {
                            ...
                            <View>
                                ...
                                >
                                    <CustomTextInput
                                        ...
                                        onFocus={() =>
                                            _openLocationSearchValue(index)
                                        }
                                        rightComponent={rightComponent}
                                    />
                                </Pressable>
