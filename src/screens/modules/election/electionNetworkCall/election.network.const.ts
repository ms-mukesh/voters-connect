export const GET_ELECTION_LIST_ENDPOINT = 'getElectionList';
export const ADD_NEW_ELECTION_ENDPOINT = 'insertNewElectionDetails';
...
export const REMOVE_VOTER_ENTRY_IN_ELECTION_MASTER_ENDPOINT =
  'removeVoterEntryForElectionMaster';
